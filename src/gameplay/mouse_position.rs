...
use bevy::math::Vec3;
use bevy::prelude::{Camera, GlobalTransform, InfinitePlane3d, Query, ResMut, Resource, Vec2, Window, With};
...
fn update_mouse_position(
    ...
    mouse_position.global = Some(global_cursor);
}